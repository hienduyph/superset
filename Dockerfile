...
RUN apt update  \
  ...
  && pip install --no-cache -e '.[postgres,trino,redshift,mysql,bigquery,gsheets,athena,clickhouse,cors,druid,mysql,redshift,starrocks,doris,presto,impala,elasticsearch,hive]'\
